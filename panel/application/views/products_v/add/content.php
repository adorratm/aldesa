...
<form id="createProduct" onsubmit="return false" action="" method="post" enctype="multipart/form-data">
    ...
    <div class="row d-none">
        <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-6">
            <div class="form-group">
                <label>Fiyat</label>
                <input disabled class="form-control form-control-sm rounded-0" placeholder="Fiyat" name="price" required min="0">
            </div>
        </div>
        <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-6">
            <div class="form-group">
                <label>İndirim Oranı (%)</label>
                <input disabled class="form-control form-control-sm rounded-0" type="number" placeholder="İndirim Oranı (%)" name="discount" required min="0" max="100">
            </div>
        </div>
    </div>
    <div class="row d-none">
        ...
        <div class="col-12 col-sm-12 col-md-12 col-lg-6 col-xl-6">
            <div class="form-group">
                ...
                <input disabled type="number" class="form-control form-control-sm rounded-0" min="0" placeholder="KDV Oranı (%)" name="vatRate" value="18" required>
            </div>
        </div>
    </div>
    <div class="row d-none">
    ...
    <div class="row d-none">
        <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
            <div class="form-group">
                ...
                <textarea disabled name="content" class="m-0 tinymce" required></textarea>
            </div>
        </div>
    </div>
    <div class="row">
    ...
    <div class="row d-none">
        <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
            <div class="form-group">
                ...
                <textarea disabled name="features" class="m-0 tinymce" required></textarea>
            </div>
        </div>
    </div>
    <div class="row">
