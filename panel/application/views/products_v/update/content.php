...
<form id="updateProduct" onsubmit="return false" method="post" enctype="multipart/form-data">
    ...
    <div class="row d-none">
        <div class="col-12 col-sm-12 col-md-12 col-lg-6 col-xl-6">
            <div class="form-group">
                <label>Fiyat</label>
                <input disabled class="form-control form-control-sm rounded-0" placeholder="Fiyat" name="price" value="<?= !empty($item->price) ? $item->price : null; ?>" required min="0">
            </div>
        </div>
        <div class="col-12 col-sm-12 col-md-12 col-lg-6 col-xl-6">
            <div class="form-group">
                <label>İndirim Oranı (%)</label>
                <input disabled class="form-control form-control-sm rounded-0" placeholder="İndirim Oranı (%)" name="discount" value="<?= !empty($item->discount) ? $item->discount : null; ?>" required min="0" max="100" type="number">
            </div>
        </div>
    </div>
    <div class="row d-none">
        <div class="col-12 col-sm-12 col-md-12 col-lg-6 col-xl-6">
            <div class="form-group">
                ...
                <select disabled name="vat" id="vat" class="form-control form-control-sm rounded-0">
        ...
        <div class="col-12 col-sm-12 col-md-12 col-lg-6 col-xl-6">
            <div class="form-group">
                ...
                <input disabled type="number" class="form-control form-control-sm rounded-0" min="0" placeholder="KDV Oranı (%)" name="vatRate" value="<?= !empty($item->vatRate) ? $item->vatRate : null; ?>" required>
            </div>
        </div>
    </div>
    <div class="row d-none">
        <div class="col-12 col-sm-12 col-md-12 col-lg-6 col-xl-6">
            <div class="form-group">
                ...
                <select disabled name="stockStatus" id="stockStatus" class="form-control form-control-sm rounded-0">
        ...
        <div class="col-12 col-sm-12 col-md-12 col-lg-6 col-xl-6">
            <div class="form-group">
                <label>Stok</label>
                <input disabled type="number" name="stock" min="0" class="form-control form-control-sm rounded-0" placeholder="Stok" value="<?= !empty($item->stock) ? $item->stock : 0; ?>">
            </div>
        </div>
    </div>
    <div class="row d-none">
