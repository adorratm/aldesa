...
class References extends MY_Controller
{
    ...
    public function index()
    {
        ...
        $viewData->items = $this->reference_model->get_all([], "rank ASC");
        $this->load->view("{$this->viewFolder}/{$viewData->subViewFolder}/index", $viewData);
    }
    public function datatable()
    {
        $items = $this->reference_model->getRows([], $_POST);
        $data = [];
    ...
    public function update_form($id)
    {
        ...
        $viewData->categories = $this->reference_category_model->get_all();
        $viewData->item = $this->reference_model->get(["id" => $id]);
        $viewData->countries = $this->general_model->get_all("countries");
        $viewData->cities = $this->general_model->get_all("cities");
        $viewData->settings = $this->general_model->get_all("settings", null, null, ["isActive" => 1]);
        $this->load->view("{$this->viewFolder}/{$viewData->subViewFolder}/content", $viewData);
    ...
    public function update($id)
    {
        ...
        if (checkEmpty($data)["error"]) :
            ...
            $reference = $this->reference_model->get(["id" => $id]);
