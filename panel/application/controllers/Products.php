            ...
            foreach ($items as $item) :
                ...
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu rounded-0 dropdown-menu-right" aria-labelledby="dropdownMenuButton">
                        ...
                        <a class="dropdown-item d-none" href="' . base_url("products/variation/$item->id") . '"><i class="fa fa-share-alt mr-2"></i>Varyasyon Grupları</a>
                        <a class="dropdown-item d-none" href="' . base_url("products/parts/$item->id") . '"><i class="fa fa-dropbox mr-2"></i>Parça İşlemleri</a>
                        <a class="dropdown-item d-none" href="' . base_url("products/dimensions/$item->id") . '"><i class="fa fa-ruler mr-2"></i>Ölçü İşlemleri</a>
                    </div>
                </div>';
                ...
                $data[] = [$item->rank, '<i class="fa fa-arrows" data-id="' . $item->id . '"></i>', $item->id, $deleteCheckbox, $item->title, $checkbox4, turkishDate("d F Y, l H:i:s", $item->updatedAt), turkishDate("d F Y, l H:i:s", $item->sharedAt), $proccessing];
            endforeach;
        endif;
        $output = [
