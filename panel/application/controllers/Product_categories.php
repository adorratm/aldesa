        ...
        if (!empty($items)) :
            ...
            <div class="dropdown">
                ...
                <div class="dropdown-menu rounded-0 dropdown-menu-right" aria-labelledby="dropdownMenuButton">
                    ...
                    <a class="dropdown-item d-none" href="' . base_url("product_categories/parts/$item->category_id") . '"><i class="fa fa-dropbox mr-2"></i>Parça İşlemleri</a>
                    <a class="dropdown-item d-none" href="' . base_url("product_categories/dimensions/$item->category_id") . '"><i class="fa fa-ruler mr-2"></i>Ölçü İşlemleri</a>
