...
class Home extends MY_Controller
{
    ...
    public function in_parent($in_parent = null, $position = null, $lang = null, $store_all_id = null)
    {
        ...
        if (in_array($in_parent, $store_all_id)) :
            $result = $this->general_model->get_all("menus", "url,title,id,top_id,page_id,target,showServices,showProductCategories", "rank ASC", ["position" => $position, "top_id" => $in_parent, "isActive" => 1, "lang" => $lang]);
            $html .=  '<ul ' . ($position == "HEADER" ? ($in_parent == 0 ? 'class="navbar-nav m-auto"' : "class='dropdown-menu'") : "class='footer-list'") . '>';
            foreach ($result as $key => $value) :
                ...
                $html .= '<li ' . (($position == "HEADER") && in_array($value->id, $store_all_id) ? ((!empty($page->url) && ($this->uri->segment(2) == strto("lower", seo($page->url)) || $this->uri->segment(3) == strto("lower", seo($page->url)))) || $this->uri->segment(2) == strto("lower", seo($value->title)) || $this->uri->segment(3) == strto("lower", seo($value->title)) || ($this->uri->segment(2) === null && $value->url === '/') ? "class='nav-item active'" : "class='nav-item'") : ((!empty($page->url) && ($this->uri->segment(2) == strto("lower", seo($page->url)) || $this->uri->segment(3) == strto("lower", seo($page->url)))) || ($this->uri->segment(2) === null && $value->url === '/') || $this->uri->segment(2) == strto("lower", seo($value->title)) || $this->uri->segment(3) == strto("lower", seo($value->title)) ? "class='nav-item'" : "class='nav-item'")) . '>';
                if (empty($value->url)) :

                    if (!empty($page->url)) :

                        $html .= '<a rel="dofollow" ' . (($position == "MOBILE" || $position == "HEADER") && in_array($value->id, $store_all_id) ? ((!empty($page->url) && ($this->uri->segment(2) == strto("lower", seo($page->url)) || $this->uri->segment(3) == strto("lower", seo($page->url)))) || $this->uri->segment(2) == strto("lower", seo($value->title)) || $this->uri->segment(3) == strto("lower", seo($value->title)) || ($this->uri->segment(2) === null && $value->url === '/') ? "class='nav-link active'" : "class='nav-link '") : ((!empty($page->url) && ($this->uri->segment(2) == strto("lower", seo($page->url)) || $this->uri->segment(3) == strto("lower", seo($page->url)))) || ($this->uri->segment(2) === null && $value->url === '/') || $this->uri->segment(2) == strto("lower", seo($value->title)) || $this->uri->segment(3) == strto("lower", seo($value->title)) ? "class='active'" : "class=''")) . ' href="' . base_url(lang("routes_page") . "/" . (!empty($page->url) ? $page->url : null)) . '" target="' . $value->target . '" title="' . $value->title . '">' . $value->title . '</a>';
                        array_push($this->viewData->page_urls, base_url(lang("routes_page") . "/" . (!empty($page->url) ? $page->url : null)));
                    else :
                        $html .= '<a rel="dofollow" ' . (($position == "MOBILE" || $position == "HEADER") && in_array($value->id, $store_all_id) ? ((!empty($page->url) && ($this->uri->segment(2) == strto("lower", seo($page->url)) || $this->uri->segment(3) == strto("lower", seo($page->url)))) || $this->uri->segment(2) == strto("lower", seo($value->title)) || $this->uri->segment(3) == strto("lower", seo($value->title)) || ($this->uri->segment(2) === null && $value->url === '/') ? "class='nav-link active'" : "class='nav-link '") : ((!empty($page->url) && ($this->uri->segment(2) == strto("lower", seo($page->url)) || $this->uri->segment(3) == strto("lower", seo($page->url)))) || ($this->uri->segment(2) === null && $value->url === '/') || $this->uri->segment(2) == strto("lower", seo($value->title)) || $this->uri->segment(3) == strto("lower", seo($value->title)) ? "class='active'" : "class=''")) . ' href="' . base_url(seo(strto("lower", $value->title))) . '" target="' . $value->target . '" title="' . $value->title . '">' . $value->title . '</a>';
                        array_push($this->viewData->page_urls, base_url(seo(strto("lower", $value->title))));
                    endif;
                else :
                    $url = parse_url($value->url, PHP_URL_SCHEME);
                    if ($url === "http" || $url === "https") :
                        $html .= '<a rel="dofollow" ' . (($position == "MOBILE" || $position == "HEADER") && in_array($value->id, $store_all_id) ? ((!empty($page->url) && ($this->uri->segment(2) == strto("lower", seo($page->url)) || $this->uri->segment(3) == strto("lower", seo($page->url)))) || $this->uri->segment(2) == strto("lower", seo($value->title)) || $this->uri->segment(3) == strto("lower", seo($value->title)) || ($this->uri->segment(2) === null && $value->url === '/') ? "class='nav-link active'" : "class='nav-link '") : ((!empty($page->url) && ($this->uri->segment(2) == strto("lower", seo($page->url)) || $this->uri->segment(3) == strto("lower", seo($page->url)))) || ($this->uri->segment(2) === null && $value->url === '/') || $this->uri->segment(2) == strto("lower", seo($value->title)) || $this->uri->segment(3) == strto("lower", seo($value->title)) ? "class='active'" : "class=''")) . ' href="' . $value->url . '" target="' . $value->target . '" title="' . $value->title . '">' . $value->title . '</a>';
                        array_push($this->viewData->page_urls, $value->url);
                    else :
                        $html .= '<a rel="dofollow" ' . (($position == "MOBILE" || $position == "HEADER") && in_array($value->id, $store_all_id) ? ((!empty($page->url) && ($this->uri->segment(2) == strto("lower", seo($page->url)) || $this->uri->segment(3) == strto("lower", seo($page->url)))) || $this->uri->segment(2) == strto("lower", seo($value->title)) || $this->uri->segment(3) == strto("lower", seo($value->title)) || ($this->uri->segment(2) === null && $value->url === '/') ? "class='nav-link active'" : "class='nav-link '") : ((!empty($page->url) && ($this->uri->segment(2) == strto("lower", seo($page->url)) || $this->uri->segment(3) == strto("lower", seo($page->url)))) || ($this->uri->segment(2) === null && $value->url === '/') || $this->uri->segment(2) == strto("lower", seo($value->title)) || $this->uri->segment(3) == strto("lower", seo($value->title)) ? "class='active'" : "class=''")) . ' href="' . base_url($value->url) . '" target="' . $value->target . '" title="' . $value->title . '">' . $value->title . '</a>';
    ...
    public function page()
    {
        ...
        $this->viewData->meta_title = !empty($this->viewData->item->title) ? strto("lower|upper", $this->viewData->item->title) : strto("lower|upper", lang("pageNotFound")) . " - " . $this->viewData->settings->company_name;
        $this->viewData->meta_desc  = clean(str_replace("”", "\"", stripslashes(!empty($this->viewData->itme->content) ? $this->viewData->item->content : $this->viewData->settings->meta_description)));
        $this->viewData->meta_keyw  = clean($this->viewData->settings->meta_keywords);
        $this->viewData->og_url                 = clean(base_url(lang("routes_page") . "/" . $seo_url));
        $this->viewData->og_image           = !empty($this->viewData->item->img_url) ? clean(get_picture("pages_v", $this->viewData->item->img_url)) : clean(get_picture("settings_v", $this->viewData->settings->logo));
        $this->viewData->og_type          = "article";
        $this->viewData->og_title           = !empty($this->viewData->item->title) ? strto("lower|upper", $this->viewData->item->title) : strto("lower|upper", lang("pageNotFound")) . " - " . $this->viewData->settings->company_name;
        $this->viewData->og_description           = clean(str_replace("”", "\"", stripslashes(!empty($this->viewData->item->content) ? $this->viewData->item->content : $this->viewData->settings->meta_description)));
    ...
    public function blogs()
    {
        ...
        $config["first_link"] = "<i class='fa fa-angles-left bx-1x'></i>";
        ...
        $config["next_link"] = "<i class='fa fa-angle-right bx-1x'></i>";
        $config["next_tag_open"] = "<li class='page-item'>";
        $config["next_tag_close"] = "</li>";
        $config["last_link"] = "<i class='fa fa-angles-right bx-1x'></i>";
     ...
     * Reference Detail
     */
    public function reference_detail($seo_url)
    {
        $this->viewData->reference = $this->general_model->get("references", null, ["isActive" => 1, "lang" => $this->viewData->lang, 'seo_url' => $seo_url]);

        if (!empty($this->viewData->reference->category_id)) :
            $this->viewData->category = $this->general_model->get("reference_categories", null, ["id" => $this->viewData->reference->category_id, "isActive" => 1, "lang" => $this->viewData->lang]);
        endif;
        ...
        $this->viewData->meta_keyw  = clean($this->viewData->settings->meta_keywords);
        $this->viewData->og_url                 = clean(base_url(lang("routes_references") . "/" . lang("routes_reference_detail") . "/" . $seo_url));
        $this->viewData->og_image           = clean(get_picture("references_v", $this->viewData->reference->img_url));
        $this->viewData->og_type          = "article";
        $this->viewData->og_title           = strto("lower|upper", $this->viewData->reference->title) . " - " . $this->viewData->settings->company_name;
        $this->viewData->og_description           = clean(str_replace("”", "\"", stripslashes($this->viewData->reference->content)));
        if (empty($this->viewData->reference)) :
            $this->viewFolder = "404_v/index";
        else :
            $this->viewFolder = "reference_detail_v/index";
        endif;
        $this->render();
    }
    /**
    ...
    public function products()
    {
        ...
        */
        ...
        $config['use_page_numbers'] = TRUE;
        $config["full_tag_open"] = "<ul class='pagination justify-content-center'>";
        $config["first_link"] = "<i class='fa fa-angle-double-left bx-1x'></i>";
        $config["first_tag_open"] = "<li class='page-item'>";
        $config["first_tag_close"] = "</li>";
        $config["prev_link"] = "<i class='fa fa-angle-left bx-1x'></i>";
        $config["prev_tag_open"] = "<li class='page-item'>";
        ...
        $config["next_tag_open"] = "<li class='page-item'>";
        $config["next_tag_close"] = "</li>";
        $config["last_link"] = "<i class='fa fa-angle-double-right bx-1x'></i>";
        $config["last_tag_open"] = "<li class='page-item'>";
        $config["last_tag_close"] = "</li>";
        $config["full_tag_close"] = "</ul>";
        $config['attributes'] = array('class' => 'page-link');
    ...
    public function product_detail($seo_url)
    {
        ...
        if (!empty($this->viewData->product)) :
            ...
            $this->viewData->meta_desc           = clean(str_replace("”", "\"", stripslashes(!empty($this->viewData->product->content) ? $this->viewData->product->content : (!empty($this->viewData->product->description) ? $this->viewData->product->description : (!empty($this->viewData->product->features) ? $this->viewData->product->features : get_settings()->meta_description)))));
            $this->viewData->meta_keyw  = clean($this->viewData->settings->meta_keywords);
            ...
            $this->viewData->og_description           = clean(str_replace("”", "\"", stripslashes(!empty($this->viewData->product->content) ? $this->viewData->product->content : (!empty($this->viewData->product->description) ? $this->viewData->product->description : (!empty($this->viewData->product->features) ? $this->viewData->product->features : get_settings()->meta_description)))));
