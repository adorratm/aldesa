...
<div class="react-breadcrumbs">
    <div class="breadcrumbs-wrap">
        <img width="1920" height="500" data-src="<?= !empty($service->banner_url) ? get_picture("services_v",$service->banner_url) : get_picture("settings_v", $settings->service_logo) ?>" alt="<?= strto("lower|upper", $service->title) ?>" class="lazyload w-100 img-fluid">
            ...
            <div class="col-lg-8">
                <div class="blog-single-inner">
                    <div class="blog-content">
                        <img width="1920" height="1280" loading="lazy" data-src="<?= get_picture("services_v", $service->img_url) ?>" alt="<?= $service->title ?>" class="img-fluid border-radius w-100 lazyload mb-4" style="min-height:200px;object-fit:cover">
                        <h2><?= $service->title ?></h2>
                                            ...
                                            <?php if ($i <= 2) : ?>
                                                <div class="single-studies col-md-4 grid-item">
                                                    <div class="inner-course">
                                                        <div class="case-img">
                                                            <img width="1920" height="1280" loading="lazy" data-src="<?= get_picture("services_v", $value->img_url) ?>" alt="<?= $value->title ?>" class="lazyload rounded img-fluid" width="150" height="150">
                                                        </div>
